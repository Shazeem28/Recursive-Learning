...
3. IF YES to any question above:
   ACTIVATE: Extract the knowledge as a new skill following the claudeception
   specification. Save to .claude/skills/[skill-name]/SKILL.md
...
The claudeception skill criteria will guide whether to actually create
a new skill based on quality standards.
